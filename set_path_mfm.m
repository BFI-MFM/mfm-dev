...
addpath( fullfile(root_folder, 'TT-Toolbox/ TT-Toolbox/exp'));
addpath( fullfile(root_folder, 'TT-Toolbox/TT-Toolbox/core'));
addpath( fullfile(root_folder, 'TT-Toolbox/TT-Toolbox/cross'));
